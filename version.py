...
leads to - the release it leads to being its OWN, so 0.3.3-alpha < 0.3.1.
It is still newer than everything before that: 0.3.3-alpha > 0.3.0, measured,
...
def parse(v: str) -> tuple[tuple[int, int, int], tuple[str, ...]]:
    """("0.3.3-alpha") -> ((0, 3, 1), ("alpha",)). Raises ValueError on junk.
